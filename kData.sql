...
postagem_id INT(15) NULL DEFAULT NULL,
forms_id INT(15) NULL DEFAULT NULL,
data_post DATE NULL DEFAULT NULL,
link_post VARCHAR(50) NULL DEFAULT NULL,
n_compras INT(10) NULL DEFAULT NULL
);

CREATE TABLE formulario(
forms_id INT(15) NULL DEFAULT NULL,
link VARCHAR(50) NULL DEFAULT NULL,
perguntas VARCHAR(100) NULL DEFAULT NULL
);